...
-----------------------------------------------------------------------
	...
	--ARTIST 2
	makeLuaText('ARTIST2', 'BG by R&S Productions', 1000, 132, -1000)
	...
	--MUSICIAN 1
	makeLuaText('MUSICIAN1', 'Trickery by Mitruxo76YT', 1000, 132, -1000)
	...
	--CHARTER 1
	makeLuaText('CHARTER1', 'Chart by Súriv', 1000, 132, -1000)
