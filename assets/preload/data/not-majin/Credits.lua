...
-----------------------------------------------------------------------
	...
	--ARTIST 1
	makeLuaText('ARTIST1', 'Sprite by Romgk & Súriv', 1000, 132, -1000)
	...
	--ARTIST 2
	makeLuaText('ARTIST2', 'BG by VS Sonic.exe Team', 1000, 132, -1000)
	...
	--MUSICIAN 1
	makeLuaText('MUSICIAN1', 'Endless by MarStarBro', 1000, 132, -1000)
	...
	--MUSICIAN 2
	makeLuaText('MUSICIAN2', 'Cover by derkestguyig', 1000, 132, -1000)
	...
	--CHARTER 1
	makeLuaText('CHARTER1', 'Chart by VS Sonic.exe Team', 1000, 132, -1000)
